...
def download_angular_material(angulal_material_zip=nil)
  $VERBOSE = true
  size = ""
  angular_material_zip = 'https://github.com/angular/material/archive/v1.2.2.zip'
  ...
  FileUtils.cp_r "angular-material/material-1.2.2/src/.", "../vendor/assets/javascripts/angular-material"
  FileUtils.cp_r "angular-material/material-1.2.2/src/.", "../vendor/assets/stylesheets/angular-material"
